                ...
                <div class="container space-sm">
                    ...
                    <div class="col-sm-12 content-left">
                        ...
                        <div class="row space-xs">
                            <div class="col-sm-12">
                                <h3>Pflichtangaben im Sinne § 5 Telemediengesetz (TMG)</h3>
                                <p><strong>Zahnarztpraxis Wedding</strong><br>
                                Zahnarzt Deniz Cam<br>
                                Müllerstr. 51<br>
                                13349 Berlin<br><br>
                                Tel: 030 - 45 023 110<br></p>
                                <p>info@zahnarztpraxis-wedding.de</p>
                                
                                <p><strong>Inhaltlich verantwortlich:</strong> Deniz Cam</p>

                                <p><strong>Webseitenbetreuung:</strong>
                                ...
                                Telefon (030) 34 808 0<br>
                                Telefax (030) 34 808 200</p>
                                
                                <p><strong>Zuständige Kassenzahnärztliche Vereinigung:</strong><br>
                                Zahnärztekammer Berlin<br>
                                Stallstraße 1, 10585 Berlin<br>
                                Telefon (030) 34 808 0<br>
                                Telefax (030) 34 808 200</p>
                                
                                <p><strong>Zuständige Bezirksregierung als Approbationsbehörde:</strong><br>
                                ...
                                Deniz Cam sowie Hasan Özdipcin  sind als Zahnärzte zugelassen aufgrund der Gesetze der Bundesrepublik Deutschland</p>
                                <p><strong>Berufsrechtliche Regelungen:</strong><br>
                                Zahnheilkundegesetz (BGBl. I 1952, S. 125)<br>
                                Heilberufe-Kammergesetz<br>
                                Gebührenordnung für Zahnärzte (BGBl I 1987, S. 2316)<br>
                                Berufsordnung für Zahnärzte www.blzk.de</p>
                        </div>
                    </div>
                    <!-- /.col 9 -->
                </div>
