                    ...
                    <div class="col-sm-12 content-left">
                        ...
                        <div class="row space-xs">
                            <div class="col-sm-12">
                                ...
                                <p>Zahnarztpraxis Wedding collects and uses your personal data exclusively within the framework of the provisions of the data protection law of the Federal Republic of Germany. In the following we will inform you about the type, scope and purpose of the collection and use of personal data. You can retrieve this information on our website at any time. Data transmission and logging for internal system and statistical purposes When you access our website, your internet browser automatically transmits data to our web server for technical reasons. This includes the date and time of access, the URL of the referring website, the file accessed, the amount of data sent, the browser type and version, the operating system and your IP address. These data are stored separately from other data that you enter when using our offer. It is not possible for us to assign this data to a specific person. This data is evaluated for statistical purposes and then deleted. </p>
                                ...
                                <p><script id="CookieDeclaration" src="https://consent.cookiebot.com/c4b3b60c-39be-470f-9d36-2f07742a3ebd/cd.js" type="text/javascript" async></script></p>
                        </div>
                    </div>
                    <!-- /.col 9 -->
                </div>
